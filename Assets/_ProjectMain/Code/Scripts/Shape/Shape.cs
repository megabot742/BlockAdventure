...
public class Shape : MonoBehaviour, IPointerClickHandler, IPointerUpHandler, IPointerDownHandler, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    private float GetXPositionForShapeSquare(ShapeData shapeData, int column, Vector2 moveDistance)
    {
        ...
        if (shapeData.columns > 1)
        {
            ...
            else
            {
                ...
                if (column < middleSquareIndex1 && column < middleSquareIndex2)// move it on nagative
                {
                    shiftOnX = moveDistance.x * -1;
                    shiftOnX *= multiplier;
                }
